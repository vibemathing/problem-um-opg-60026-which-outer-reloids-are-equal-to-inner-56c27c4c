...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-60026"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-v1",
      "problem_contract_sha256": "6464a918e1708241d2e9a6fbc9a39ea377a5573426d9ba8ef317329286b0fc60",
      "problem_id": "problem:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c",
      "route_id": "route:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-source-fidelity-01",
      "graph_id": "graph:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Warning: This formulation is vague (not exact). Question Characterize the set $\\{f\\in\\mathsf{FCD} \\mid (\\mathsf{RLD})_{\\mathrm{in}} f=(\\mathsf{RLD})_{\\mathrm{out}} f\\}$. In other words, simplify this formula. The problem seems rather difficult."
          },
          "statement_sha256": "c6594087348e076d2d368a1f30f734d83e2921624905dab96229315b2c241933"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-root",
      "route_id": "route:um-opg-60026-which-outer-reloids-are-equal-to-inner-56c27c4c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-60026-a6c7c6aeff6d",
        "url": "https://www.unsolvedmath.com/problems/OPG-60026"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
